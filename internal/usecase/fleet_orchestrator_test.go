...
func TestProvisionApp_ResourceClaim_GetsNoIngressRoute(t *testing.T) {
	...
	resources := newTestResourceProvisioner(&fakeFleetProvisioner{}, newFakeResourceRepo(), nil, &fakeSnapshotter{}, &fakeVolumeBinder{}, testEngine(), testEndpointNaming(), nil, 0)
